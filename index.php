...
<head>
    <meta charset="utf-8">
    <title>MyTube - Admin Panal</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>MyTube</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="table.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>SUBSCRIBED</a>
                        <a href="Feedback.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>FEED-BACK</a>
                           <a href="Review.php" class="nav-item nav-link "><i class="fa fa-table me-2"></i>Review</a>
